...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Hero Content Area - aligned with comfortable top margin, raw text view with drop shadows */}
      <div className="relative z-10 max-w-4xl px-6 md:px-16 lg:px-24 text-left flex flex-col items-start justify-center pt-28 md:pt-36 pb-16">
